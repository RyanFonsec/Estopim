...
private:
    ...
    static const int MAX_SPEED     = 2;   // pixels por passo — muda aqui para ajustar velocidade
    static const int MOVE_INTERVAL = 30;  // ms entre passos — muda aqui para ajustar velocidade
